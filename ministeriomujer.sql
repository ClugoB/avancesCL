...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-12-2024 a las 20:17:43
...
--
-- Estructura de tabla para la tabla `ayudantes_en_espera`
--

CREATE TABLE `ayudantes_en_espera` (
  `id` int(11) NOT NULL,
  `tipos_movimientos` varchar(255) NOT NULL,
  `nombre_movimiento` varchar(255) NOT NULL,
  `nombre_apellido` varchar(255) NOT NULL,
  `descripcion_cargo` varchar(255) NOT NULL,
  `num_id_lider` varchar(50) NOT NULL,
  `cedula_lider` varchar(50) NOT NULL,
  `ciudad` varchar(100) NOT NULL,
  `estado` varchar(100) NOT NULL,
  `municipio` varchar(100) NOT NULL,
  `parroquia` varchar(100) NOT NULL,
  `embarazada` enum('Si','No') NOT NULL,
  `tiempo_embarazada` varchar(50) DEFAULT NULL,
  `discapacidad` enum('Si','No') NOT NULL,
  `tipo_discapacidad` varchar(100) DEFAULT NULL,
  `genero` varchar(50) NOT NULL,
  `tipo_genero` varchar(100) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `ayudantes_en_espera`
--

INSERT INTO `ayudantes_en_espera` (`id`, `tipos_movimientos`, `nombre_movimiento`, `nombre_apellido`, `descripcion_cargo`, `num_id_lider`, `cedula_lider`, `ciudad`, `estado`, `municipio`, `parroquia`, `embarazada`, `tiempo_embarazada`, `discapacidad`, `tipo_discapacidad`, `genero`, `tipo_genero`, `correo`, `fecha_nacimiento`, `fecha_creacion`) VALUES
(8, 'Movimiento Social', 'prueba24', 'asddad', 'Recepcionista', 'E', '2133', 'Apartaderos Cojedes', 'Guárico', 'Andrés Eloy Blanco', 'Aguas Calientes', 'Si', '8 meses', 'Si', 'Discapacidad psicosocial', 'No binario', NULL, 'crhystopherlugo@gmail.com', '2024-12-13', '2024-12-18 18:41:53');
...
CREATE TABLE `datos_ayudantes` (
  ...
  `embarazada` varchar(3) DEFAULT NULL,
  `tiempo_embarazada` int(11) DEFAULT NULL,
  ...
  `tipos_movimientos` varchar(255) DEFAULT NULL,
  `nombre_movimiento` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `datos_ayudantes`
--

INSERT INTO `datos_ayudantes` (`id`, `nombre_apellido`, `descripcion_cargo`, `num_id`, `cedula`, `ciudad`, `estado`, `municipio`, `parroquia`, `embarazada`, `tiempo_embarazada`, `discapacidad`, `tipo_discapacidad`, `genero`, `tipo_genero`, `correo`, `fecha_nacimiento`, `fecha_registro`, `id_movimiento`, `tipos_movimientos`, `nombre_movimiento`) VALUES
(31, 'assa', 'Profesor', 'E', '121323214', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-12-05 16:35:18', 49, NULL, NULL),
(32, 'aas', 'Profesor', 'G', '1231232', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-12-05 19:40:41', 50, NULL, NULL),
(33, 'aqsad', 'Profesor', 'G', '1231313113', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-12-17 15:21:19', 51, NULL, NULL),
(34, 'ASASDSD', 'Supervisor', '', '', 'Arapuey', 'Monagas', 'Andrés Eloy Blanco', 'Agua Santa', 'No', NULL, 'Si', 'Discapacidad psicosocial', 'No binario', NULL, 'crhystopherlugo@gmail.com', '2024-12-06', '2024-12-18 18:01:54', NULL, 'Movimiento Social', 'prueba24'),
(35, 'AAA', 'Recepcionista', '', '', 'Aragua de Barcelona', 'Mérida', 'Andrés Bello', 'Agua Viva', 'No', NULL, 'No', NULL, 'Hombre', NULL, 'crhystopherlugo@gmail.com', '2024-12-05', '2024-12-18 18:02:00', NULL, 'Movimiento Apoyo', 'aaaa');
...
CREATE TABLE `encuesta` (
  ...
  `pregunta1` mediumtext DEFAULT NULL,
  `pregunta2` mediumtext DEFAULT NULL,
  `pregunta3` mediumtext DEFAULT NULL,
  `pregunta4` mediumtext DEFAULT NULL,
  `pregunta5` mediumtext DEFAULT NULL,
  `pregunta6` mediumtext DEFAULT NULL,
  `pregunta7` mediumtext DEFAULT NULL,
  `pregunta8` mediumtext DEFAULT NULL,
  `pregunta9` mediumtext DEFAULT NULL,
  `pregunta10` mediumtext DEFAULT NULL,
  `pregunta11` mediumtext DEFAULT NULL,
  `pregunta12` mediumtext DEFAULT NULL,
  `pregunta13` mediumtext DEFAULT NULL,
  `pregunta14` mediumtext DEFAULT NULL,
  `pregunta15` mediumtext DEFAULT NULL,
  `pregunta16` mediumtext DEFAULT NULL,
  `pregunta17` mediumtext DEFAULT NULL,
  `pregunta18` mediumtext DEFAULT NULL,
  `pregunta19` mediumtext DEFAULT NULL,
  `pregunta20` mediumtext DEFAULT NULL,
  `pregunta21` mediumtext DEFAULT NULL,
  `pregunta22` mediumtext DEFAULT NULL,
  `pregunta23` mediumtext DEFAULT NULL,
  `pregunta24` mediumtext DEFAULT NULL,
  `pregunta25` mediumtext DEFAULT NULL,
  `pregunta26` mediumtext DEFAULT NULL,
  `pregunta27` mediumtext DEFAULT NULL,
  `pregunta28` mediumtext DEFAULT NULL,
  `pregunta29` mediumtext DEFAULT NULL,
  `pregunta30` mediumtext DEFAULT NULL,
  `pregunta31` mediumtext DEFAULT NULL,
  `pregunta32` mediumtext DEFAULT NULL,
  `pregunta33` mediumtext DEFAULT NULL,
  `pregunta34` mediumtext DEFAULT NULL,
  `pregunta35` mediumtext DEFAULT NULL,
  `pregunta36` mediumtext DEFAULT NULL,
  `pregunta37` mediumtext DEFAULT NULL,
  `pregunta38` mediumtext DEFAULT NULL,
  `pregunta39` mediumtext DEFAULT NULL,
  `pregunta40` mediumtext DEFAULT NULL,
  `pregunta41` mediumtext DEFAULT NULL,
  `pregunta42` mediumtext DEFAULT NULL,
  `pregunta43` mediumtext DEFAULT NULL,
  `pregunta44` mediumtext DEFAULT NULL,
  `pregunta45` mediumtext DEFAULT NULL,
  `pregunta46` mediumtext DEFAULT NULL,
  `pregunta47` mediumtext DEFAULT NULL,
  `pregunta48` mediumtext DEFAULT NULL,
  `pregunta49` mediumtext DEFAULT NULL,
  `pregunta50` mediumtext DEFAULT NULL,
  `pregunta51` mediumtext DEFAULT NULL,
  `pregunta52` mediumtext DEFAULT NULL,
  `pregunta53` mediumtext DEFAULT NULL,
  `pregunta54` mediumtext DEFAULT NULL,
  `pregunta55` mediumtext DEFAULT NULL,
  `pregunta56` mediumtext DEFAULT NULL,
  `pregunta57` mediumtext DEFAULT NULL,
  `pregunta58` mediumtext DEFAULT NULL,
  `pregunta59` mediumtext DEFAULT NULL,
  `pregunta60` mediumtext DEFAULT NULL,
  `pregunta61` mediumtext DEFAULT NULL,
  `pregunta62` mediumtext DEFAULT NULL,
  `pregunta63` mediumtext DEFAULT NULL,
  `pregunta64` mediumtext DEFAULT NULL,
  `pregunta65` mediumtext DEFAULT NULL,
  `pregunta66` mediumtext DEFAULT NULL,
  `pregunta67` mediumtext DEFAULT NULL,
  `pregunta68` mediumtext DEFAULT NULL,
...
CREATE TABLE `form_mujeres` (
  ...
  `ciudad_ubicado` varchar(100) DEFAULT NULL,
  `estado_ubicado` varchar(100) DEFAULT NULL,
  `municipio_ubicado` varchar(100) DEFAULT NULL,
  `parroquia_ubicado` varchar(100) DEFAULT NULL,
  `estados_presentes` varchar(100) DEFAULT NULL,
  `movimiento_tipo` varchar(100) DEFAULT NULL,
  `nombre_lider` varchar(100) DEFAULT NULL,
  `apellido_lider` varchar(100) DEFAULT NULL,
  `num_id_lider` varchar(5) DEFAULT NULL,
  `cedula_lider` varchar(15) DEFAULT NULL,
  `codigo_lider` varchar(50) DEFAULT NULL,
  `numero_telefono_lider` varchar(15) DEFAULT NULL,
  `fecha_nacimiento_lider` date DEFAULT NULL,
  `correo_lider` varchar(255) DEFAULT NULL,
  `nombre_apellido_ayudantes` varchar(255) DEFAULT NULL,
  `num_id_ayudantes` varchar(5) DEFAULT NULL,
  `cedula_ayudantes` varchar(15) DEFAULT NULL,
  `descripcion_cargo_ayudantes` varchar(255) DEFAULT NULL,
  `cantidad_hombres` int(11) DEFAULT 0,
  `cantidad_mujeres` int(11) DEFAULT 0,
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp(),
  `contrasena_movimiento` varchar(255) NOT NULL,
  `razon_movimiento` varchar(255) DEFAULT NULL,
  `tipos_movimientos` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `form_mujeres`
--

INSERT INTO `form_mujeres` (`id`, `nombre_movimiento`, `descripcion_movimiento`, `ciudad_ubicado`, `estado_ubicado`, `municipio_ubicado`, `parroquia_ubicado`, `estados_presentes`, `movimiento_tipo`, `nombre_lider`, `apellido_lider`, `num_id_lider`, `cedula_lider`, `codigo_lider`, `numero_telefono_lider`, `fecha_nacimiento_lider`, `correo_lider`, `nombre_apellido_ayudantes`, `num_id_ayudantes`, `cedula_ayudantes`, `descripcion_cargo_ayudantes`, `cantidad_hombres`, `cantidad_mujeres`, `fecha_registro`, `contrasena_movimiento`, `razon_movimiento`, `tipos_movimientos`) VALUES
(49, 'prueba24', '213213', 'Apartaderos Mérida', 'Mérida', 'Andrés Eloy Blanco', 'Aguas Calientes', 'Amazonas,Anzoátegui', 'Micro movimiento', 'Crhystopher', 'Lugo', 'J', '121334', '0414', '1112312', '2024-12-04', 'crhystopherlugo@gmail.com', NULL, NULL, NULL, NULL, 1, 1, '2024-12-05 16:35:18', '$argon2i$v=19$m=65536,t=4,p=1$dldITEFTSkg1Ri5rS0VBMA$xrDqEM2ZxAMYWLNIGxZCvZ7owNJ2TTtV+2pUOZJdxHU', 'aaaa', 'Movimiento Social'),
(50, 'aaaa', 'ASSAD', 'Aragua de Barcelona', 'La Guaira', 'Andrés Eloy Blanco', 'Aguas Calientes', 'Amazonas,Anzoátegui,Apure', 'Micro movimiento', 'aaa', 'aa', 'E', '12213', '0412', '12133', '2024-12-21', 'crhystopherlugo@gmail.com', NULL, NULL, NULL, NULL, 1, 1, '2024-12-05 19:40:41', '$argon2i$v=19$m=65536,t=4,p=1$QVNPRFRNOGdKUnE3bHhjLw$+pMK6p2nvK9M2pGeIm2yDZTgZvMtYi4o0AD9snDIN+M', 'DASDA', 'Movimiento Apoyo'),
(51, 'swqdf', '213213', 'Araguita', 'Miranda', 'Andrés Eloy Blanco', 'Aguedo Felipe Alvarado', 'Amazonas,Anzoátegui', 'Micro movimiento', 'aa', 'aa', 'G', '1231344', '0414', '2132131', '2024-12-12', 'crhystopherlugo@gmail.com', NULL, NULL, NULL, NULL, 1, 1, '2024-12-17 15:21:19', '$argon2i$v=19$m=65536,t=4,p=1$em5zUlUvYnVQYVpVeGlHeA$eODRiQesucw1UdJaXeX9H1OFXyfpbYXcIqSKdTI7E5E', 'aasd', 'Movimiento Social');
...
--
-- Estructura de tabla para la tabla `rechazados`
--
...
CREATE TABLE `rechazados` (
  ...
  `num_id_lider` varchar(50) DEFAULT NULL,
  `cedula_lider` varchar(50) DEFAULT NULL,
  `ciudad` varchar(100) DEFAULT NULL,
  `estado` varchar(100) DEFAULT NULL,
  `municipio` varchar(100) DEFAULT NULL,
  `parroquia` varchar(100) DEFAULT NULL,
  `embarazada` enum('sí','no') DEFAULT NULL,
  `tiempo_embarazada` int(11) DEFAULT NULL,
  ...
  `fecha_rechazo` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `rechazados`
--

INSERT INTO `rechazados` (`id`, `tipos_movimientos`, `nombre_movimiento`, `nombre_apellido`, `descripcion_cargo`, `num_id_lider`, `cedula_lider`, `ciudad`, `estado`, `municipio`, `parroquia`, `embarazada`, `tiempo_embarazada`, `discapacidad`, `tipo_discapacidad`, `genero`, `tipo_genero`, `correo`, `fecha_nacimiento`, `fecha_creacion`, `fecha_rechazo`) VALUES
(1, 'Movimiento Social', 'swqdf', 'ASASDSD', 'Mensajero', 'G', '123213', 'Adícora', 'Miranda', 'Andrés Bello', 'Agua Larga', '', 7, '', NULL, 'Mujer', NULL, 'crhystopherlugo@gmail.com', '2024-12-06', '2024-12-17 13:32:24', '2024-12-18 13:58:35'),
(2, 'Movimiento Social', 'prueba24', 'AAA', 'Técnico', 'J', '12121', 'Apartaderos Mérida', 'La Guaira', 'Andrés Bello', 'Agua Clara', '', 8, '', NULL, 'No binario', NULL, 'crhystopherlugo@gmail.com', '2025-01-04', '2024-12-17 13:36:59', '2024-12-18 13:58:40'),
(3, 'Movimiento Apoyo', 'aaaa', 'ASASDSDAA', 'Mensajero', 'G', '123213', 'Adícora', 'Miranda', 'Andrés Bello', 'Agua Larga', '', NULL, '', NULL, 'Mujer', NULL, 'crhystopherlugo@gmail.com', '2024-12-06', '2024-12-17 13:34:19', '2024-12-18 14:02:02'),
(4, 'Movimiento Social', 'prueba24', 'AAA', 'Supervisor', 'J', '123132', 'Araguita', 'Miranda', 'Andrés Eloy Blanco', 'Agua Viva', 'no', NULL, 'no', NULL, 'No binario', NULL, 'crhystopherlugo@gmail.com', '2024-12-27', '2024-12-18 14:07:52', '2024-12-18 14:08:00'),
(5, 'Movimiento Social', 'prueba24', 'AAA', 'Recepcionista', 'E', '12313213', 'Arapuey', 'Monagas', 'Andrés Eloy Blanco', 'Aguasay', 'sí', 8, 'sí', 'Discapacidad visual', 'Otro', 'asad', 'crhystopherlugo@gmail.com', '2025-01-10', '2024-12-18 14:33:01', '2024-12-18 14:40:15');
...
CREATE TABLE `usuarios` (
  ...
  `num_id` varchar(11) DEFAULT NULL,
...
--
-- Indices de la tabla `ayudantes_en_espera`
--
ALTER TABLE `ayudantes_en_espera`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `rechazados`
--
ALTER TABLE `rechazados`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `ayudantes_en_espera`
--
ALTER TABLE `ayudantes_en_espera`
...
--
-- AUTO_INCREMENT de la tabla `rechazados`
--
ALTER TABLE `rechazados`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
-- Eventos
--
CREATE DEFINER=`root`@`localhost` EVENT `eliminar_rechazados` ON SCHEDULE EVERY 1 DAY STARTS '2024-12-17 14:52:04' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    DELETE FROM rechazados WHERE fecha_rechazo < NOW() - INTERVAL 30 DAY;
END$$
